...
const Home = () => {
  return (
    <div className="w-full h-[95vh] bg-zinc-50 ">
      <div className="mainHeading px-5 py-24 text-[6rem] tracking-tighter border border-b-gray-400 font-semibold leading-[85px] ">
        <h1>WE CREATE</h1>
      ...
      <div className=" flex justify-between items-start py-4 px-5">
